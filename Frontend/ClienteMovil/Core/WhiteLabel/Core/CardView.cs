...
namespace WhiteLabel.Core
{
	...
	public class CardView : ContentView
	{
		...
		public CardView()
		{
			...
			WhiteLabel.Core.Effects.SetShadowIOSColor(this, new Color(0.0, 0.0, 0.0, 0.5));
			UpdateCorners();
			UpdateShadow();
			UpdateBackground();
			UpdateShadowSize();
		...
		private void UpdateCorners()
		{
			...
			if (!(runtimePlatform == "iOS"))
			{
				...
				{
					WhiteLabel.Core.Effects.SetCornerRadius(this, CornerRadius);
				}
			}
			else
			{
				WhiteLabel.Core.Effects.SetCornerRadius(Content, CornerRadius);
			}
		}

		private void UpdateShadowSize()
		{
			WhiteLabel.Core.Effects.SetShadowSize(this, ShadowSize);
		}

		private void UpdateShadowOpacity()
		{
			WhiteLabel.Core.Effects.SetShadowOpacity(this, ShadowOpacity);
		}

		private void UpdateShadow()
		{
			WhiteLabel.Core.Effects.SetShadow(this, HasShadow);
		}
