...
{
    /// <summary>
    /// Addes properties to the CarouselViewControl that help achieve 
    /// animations associate with drag gestures.
    /// </summary>
    public class ExtendedCarouselViewControl : CarouselViewControl
    {
        ...
        protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            else if (propertyName == nameof(Position))
            {
                ...
                {
                    // Still transitioning (android fix, see ExtendedCarouselViewRenderer)
